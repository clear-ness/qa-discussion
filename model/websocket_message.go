...
const (
	WEBSOCKET_EVENT_INBOX_MESSAGE = "inbox_message"
...
func NewWebSocketEvent(event, teamId, userId string, omitUsers map[string]bool) *WebSocketEvent {
	return &WebSocketEvent{Event: event, Data: make(map[string]interface{}),
		Broadcast: &WebsocketBroadcast{TeamId: teamId, UserId: userId, OmitUsers: omitUsers}}
}
